...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:param name="course.css">resources/course.css</xsl:param>
  ...
  <xsl:template match="SlideShow">
    <html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr">
      <head>
        ...
        <meta name="copyright" content="Stéphane Sire, Oppidoc, Journée des professionnels du numérique, 19/02/2014, Tours {$timestamp}" />
        ...
        <link rel="stylesheet" type="text/css" media="screen, projection, print" href="{$course.css}" />
